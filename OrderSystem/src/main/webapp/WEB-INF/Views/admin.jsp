						...
						<div class="panel-body">
							<form class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" placeholder="菜品名称" data-bind='value : foodName, valueUpdate: "afterkeydown"'>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" placeholder="菜品单价" data-bind='value : foodPrice, valueUpdate: "afterkeydown"'>
									</div>
								</div>
								<div class="form-group">
						...
						<div data-bind="foreach : orders">
							<div class=" media col-md-12 well" style="margin: 5px 5px !important;">
								...
								<div class="media-body">
									...
									<div class="pull-right">
										<button class="btn btn-primary" data-bind='click : completeOrder, disable : isCompleted, html : completeButton'></button>
									</div>
								</div>
							</div>
						</div>
